        ...
        <div class="row clearfix">
            ...
            <div class="content-column col-lg-6 col-md-12 col-sm-12">
                <div class="inner-column wow slideInLeft">
                    ...
                    <div class="text">In order to increase their engineering capabilities, we build quality solutions and software for technology companies.</div>
    ...
    <div class="auto-container">
        <div class="row clearfix">
            ...
            <div class="content-column col-lg-12 col-md-12 col-md-12">
                <div class="inner-column">
                    <h2>{{__('home.who-we-are')}}</h2>
                    <div class="text">HumanOne is your specialized partner in the development of software solutions and digitalization by combining the best engineering talent with a total commitment to meeting the unique expectations of each of its clients.
                        We offer to update and innovate the management processes used by your company in order to optimize efficiency and reduce costs.
                        HumanOne favors a horizontal, agile, flexible and transparent organization. We deploy all of our energies, which makes us a reliable and proven software engineering provider.</div>
                    <a href="who-we-are" class="theme-btn btn-style-three">Get to know us <span class="icon flaticon-next-3"></span></a>
                </div>
            </div>
            <!-- Content Column -->
            <div class="content-column col-lg-12 col-md-12 col-md-12">
                <div class="inner-column">
                    <h2>Our Promise</h2>
                    <div class="text">We bring to our clients the best engineering talent, a deep knowledge of each sector in which we operate, and an unwavering dedication to satisfying each of our clients' requests
                        No matter how complex your project is, we deploy all of our resources to deliver the most technological and efficient solutions and softwares. We offer digital workflows that create exceptional experiences and maximize productivity.
                        Our added value is manifested in the combination of solid and restricted human relationships with the upmost technology in our multiple missions.
                        We attach great importance to the ethics and values of our profession such as integrity, confidentiality, transparency and honesty of our proposals.</div>
                </div>
            </div>
        ...
        <div class="services-block-two">
            <div class="inner-box">
                <div class="row clearfix">
                    ...
                    <div class="content-column col-lg-6 col-md-6 col-sm-12">
                        <div class="inner-column wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="text">As soon as HumanOne receives your project, we give you instant access to all of our technological skills supported by our ready-to-use IT infrastructure and our most proven software engineering processes. </div>
                        </div>
                    </div>
